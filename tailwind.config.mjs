	...
	theme: {
		extend: {
			...
			colors: {
				...
				"bluish-black": "oklch(25% 0.029 221.9)",
			},
			fontFamily: {
			...
			typography: ({ theme }) => ({
				DEFAULT: {
					css: {
						...
						"--tw-prose-body": theme("colors.bluishBlack"),
						"--tw-prose-headings": theme("colors.bluishBlack"),
						"--tw-prose-lead": theme("colors.bluishBlack"),
						"--tw-prose-links": theme("colors.bluishBlack"),
						"--tw-prose-bold": theme("colors.bluishBlack"),
						"--tw-prose-counters": theme("colors.bluishBlack"),
						"--tw-prose-bullets": theme("colors.bluishBlack"),
						"--tw-prose-hr": theme("colors.bluishBlack"),
						"--tw-prose-quotes": theme("colors.bluishBlack"),
						"--tw-prose-quote-borders": theme("colors.bluishBlack"),
						"--tw-prose-captions": theme("colors.bluishBlack"),
						"--tw-prose-code": theme("colors.bluishBlack"),
						"--tw-prose-pre-code": theme("colors.bluishBlack"),
						"--tw-prose-pre-bg": theme("colors.bluishBlack"),
						"--tw-prose-th-borders": theme("colors.bluishBlack"),
						"--tw-prose-td-borders": theme("colors.bluishBlack"),
